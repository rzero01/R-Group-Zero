        ...
        :
          <div className="no-wallet">
            ...
            <div className="use-block-explorer">
              <br />
              <strong>R Club Card</strong> is the first NFT issued by <strong>The R Group</strong>, and it's an important certificate for the first members of the club!<br />
              <br />
              Membership to the collective and all of the <strong>benefits</strong> come from holding the Cards.<br />
              <br />
